...
from custom_components.nrgkick.api import NRGkickApiClientCommunicationError
...
def test_normalize_host_url_port_none_and_invalid_host() -> None:
    ...
    with (
        patch("custom_components.nrgkick.config_flow.cv.url", return_value="x"),
        patch("custom_components.nrgkick.config_flow.yarl.URL", return_value=_Url()),
    ):
    ...
    with (
        patch("custom_components.nrgkick.config_flow.cv.url", return_value="x"),
        patch(
            "custom_components.nrgkick.config_flow.yarl.URL",
